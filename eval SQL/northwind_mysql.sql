...
--
-- DÃ©chargement des donnÃ©es de la table `suppliers`
--
...
--
-- DÃ©chargement des donnÃ©es de la table `customers`
--
...
--
-- DÃ©chargement des donnÃ©es de la table `order details`
--
...
select ProductName, UnitPrice * 1000 as price
from products
...
/*3- Nombre de produits mis à disposition par les founisseurs francais (tri par nombre de produits décroissant)*/

select CompanyName, count(ProductName) as quantityproducts
from suppliers 
...
/*4- Liste des clients francais ayant passé plus de 10 commandes*/
...
select companyname, count(ShipVia) as c
from customers
